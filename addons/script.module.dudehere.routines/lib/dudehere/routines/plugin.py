...
class ContextMenu:
	...
	def _build_url(self, arguments, script):
		if 'title' in arguments.keys(): arguments['title'] = arguments['title'].encode('ascii', 'ignore')
		if 'display' in arguments.keys(): arguments['display'] = arguments['display'].encode('ascii', 'ignore')
...
class Plugin():
	...
	def build_plugin_url(self, query):
		if 'title' in query.keys(): query['title'] = query['title'].encode('ascii', 'ignore')
		if 'display' in query.keys(): query['display'] = query['display'].encode('ascii', 'ignore')
	...
	def eod(self, view=None, content=None, viewid=None):
