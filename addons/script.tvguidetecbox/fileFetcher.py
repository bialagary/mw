...
MAIN_URL = 'http://tecbox.tv/repo/teciptvguide/'
...
class FileFetcher(object):
    ...
    basePath = xbmc.translatePath(os.path.join('special://profile', 'addon_data', 'script.tvguidetecbox'))
    filePath = ''
    fileUrl = ''
    addon = None
    ...
    def fetchFile(self):
        ...
        if fetch:
            ...
            if os.path.getsize(tmpFile) > 256:
                ...
                xbmc.log('[script.tvguidetecbox] file %s was downloaded' % self.filePath, xbmc.LOGDEBUG)
            else:
