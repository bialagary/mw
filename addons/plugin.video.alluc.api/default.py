...
if DB_TYPE == 'mysql':
	DB=MyDatabaseAPI(DB_ADDRESS, DB_NAME, DB_USER, DB_PASS, DB_PORT, version=1, connect=ADDON.get_setting('database_mysql_init')=="false")
else:
	DB=MyDatabaseAPI(DB_FILE, version=1, connect=ADDON.get_setting('database_sqlite_init')=="false")


def update_run():
	if plugin.check_version(ADDON.get_setting('version'), '0.4.17'):
...
plugin.register(['tv_watchlist', 'tv_trending', 'tv_popular', 'tv_recommended', 'tv_custom_list', 'tv_search', 'tv_similar'], tv_list)
