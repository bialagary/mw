...
data={"ANIMUSTVNOW":"Animal Planet","BRAVUSTVNOW":"Bravo","CARTUSTVNOW":"Cartoon Network",
      "ESPNUSTVNOW":"ESPN","CNN0USTVNOW":"CNN","CNBCUSTVNOW":"CNBC",
      "USA0USTVNOW":"USA","SYFYUSTVNOW":"Syfy","HISTUSTVNOW":"History",
      "DISCUSTVNOW":"Discovery Channel","COMEUSTVNOW":"Comedy Central","TNT0USTVNOW":"TNT",
      "WLYHUSTVNOW":"CW","WHTMUSTVNOW":"ABC","WPMTUSTVNOW":"FOX",
      "FX00USTVNOW":"FX","WPSUUSTVNOW":"PBS","FOODUSTVNOW":"Food Network",
      "TBS0USTVNOW":"TBS","NICKUSTVNOW":"Nickelodeon","WHP0USTVNOW":"CBS",
      "WGALUSTVNOW":"NBC","AETVUSTVNOW":"A&E","LIFEUSTVNOW":"Lifetime",
      "SPIKUSTVNOW":"Spike","FOXNUSTVNOW":"Fox News","NATGUSTVNOW":"National Geographic",
      "WHVLUSTVNOW":"My9","AMC0USTVNOW":"AMC"
      }
...
class Ustvnow:
    ...
    def get_channels(self, quality=1, stream_type='rtmp'):
        ...
        for channel in re.finditer('<div id="content_(.+?)" class="panel" noback="noback" title="">.+?src="' + 
            ...
            if not url.startswith('http'):
                ...
                id = re.split('mp4:',url)[1]
                length=int(len(id))-1
                id=id[5:length]
                try: channels.append({'name': data[id], 'url': url, 
                               'icon': icon, 'now': now})
                except:pass
        return channels        
    ...
    def _login(self):
        ...
        if re.search('Login Complete', response.read()): valid = True
	else: valid = False
