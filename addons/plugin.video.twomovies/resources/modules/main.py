...
artwork = xbmc.translatePath(os.path.join('http://addonrepo.com/xbmchub/2movies/art/', ''))
#================Threading===========================================
...
def viewQueue():
     addDir('[COLOR blue]Start Downloads[/COLOR]','none','download',artwork +'downloads/Downloads_Start.png','','',1)
     queue = cache.get('queue')
     if queue:
          queue_items = sorted(eval(queue), key=lambda item: item[1])
          print queue_items
...
def OLDaddDLDir(name,url,mode,thumb,labels,dlfoldername,favtype,mainimg):
        contextMenuItems = []
        params = {'url':url, 'mode':mode, 'name':dlfoldername, 'thumb':thumb, 'dlfoldername':dlfoldername, 'favtype':favtype, 'mainimg':mainimg}
...
def addDLDir(name,url,mode,thumb,labels,dlfoldername,favtype,mainimg,totalItems):
        contextMenuItems = []
        sitethumb = thumb
        sitename = name
        try:
...
#********************TV DOWNLOAD DIR***************************
def OLDaddTVDLDir(name,url,mode,thumb,labels,dlfoldername,favtype,mainimg):
        contextMenuItems = []
        params = {'url':url, 'mode':mode, 'name':dlfoldername, 'thumb':thumb, 'dlfoldername':dlfoldername, 'favtype':favtype,'mainimg':mainimg}
...
def addTVDLDir(name,url,mode,thumb,labels,dlfoldername,favtype,mainimg,totalItems):
        contextMenuItems = []
        sitethumb = thumb
        sitename = name
        try:
...
# Standard addDir
def addDir(name,url,mode,thumb,labels,favtype,totalItems):
        contextMenuItems = []
        sitethumb = thumb
        sitename = name
        try:
