...
import re,sys,urllib2,HTMLParser,xbmc
...
def agent():
    ...
    installed_version = 'Kodi %s.%s %s' % (get_installedversion()['major'], get_installedversion()['minor'], get_installedversion()['tag'])
    return '%s (Python v%s)' % (installed_version, sys.version)
