# BIG THANKS TO HAKAMAC FOR HIS CODE, SHADOW CREW FOR ALLOW ME TO USE THEIR ADDON AND TO METTLE KETTLE FOR HIS HELP AND SUPPORT
# -*- coding: utf-8 -*-
...
RHBase = 'http://njmweb.we.bs/addon_files/Main_Menu2.xml'
...
def addon_log(string):
    if debug == 'true':
        xbmc.log("[addon.live.NJMSoccerr3-%s]: %s" %(string))
